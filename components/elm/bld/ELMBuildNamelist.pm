...
sub setup_logic_fates {
  ...
  if ( value_is_true( $nl_flags->{'use_fates'})  ) {
    ...
    add_default($test_files, $nl_flags->{'inputdata_rootdir'}, $definition, $defaults, $nl, 'use_fates_crown_damage',       'use_fates'=>$nl_flags->{'use_fates'});
