module elm_varctl
  ...
  logical, public            :: use_fates_canopy_damage = .false.       ! true => turn on canopy crown damage
  logical, public            :: use_fates_understory_damage = .false.   ! true => turn on understory crown damage
